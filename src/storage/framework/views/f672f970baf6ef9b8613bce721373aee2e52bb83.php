...
<section class="page-area pro-content">
					...
					<div class="tab-pane fade show active form-validate-login" id="login" role="tabpanel" aria-labelledby="login-tab">
						...
						<div class="from-group mb-3">
								...
								<div class="input-group col-12">
									...
									<span class="form-text text-muted error-content" hidden><?php echo app('translator')->get('website.Please enter your password'); ?></span>										</div>
							</div>
						...
						<form name="signup" enctype="multipart/form-data" class="form-validate" action="<?php echo e(URL::to('/signupProcess')); ?>" method="post">
							...
							<div class="from-group mb-3">
								...
								<div class="from-group mb-3">
									...
									<div class="input-group col-12">
										<input  name="email" type="text" class="form-control email-validate" id="inlineFormInputGroup" placeholder="<?php echo app('translator')->get('website..Please enter your valid email address'); ?>" value="<?php echo e(old('email')); ?>">
										<span class="form-text text-muted error-content" hidden><?php echo app('translator')->get('website.Please enter your valid email address'); ?></span>
									</div>
								</div>
								<div class="from-group mb-3">
								...
								<div class="from-group mb-3">
									<div class="col-12"> <label for="inlineFormInputGroup"><strong style="color: red;">*</strong><?php echo app('translator')->get('website.Confirm Password'); ?></label></div>
										<div class="input-group col-12">
											<input type="password" class="form-control password" id="re_password" name="re_password" placeholder="<?php echo app('translator')->get('website.Please enter your password'); ?>">
											...
											<span class="form-text text-muted error-content re-password-content" hidden><?php echo app('translator')->get('website.Password does not match the confirm password'); ?></span>
										</div>
									</div>
									<div class="from-group mb-3">
  ...
  </section><?php /**PATH /var/www/grandisoeemporium_demo/src/resources/views/auth/logins/login2.blade.php ENDPATH**/ ?>