                                            ...
                                            <?php if($payment_methods['active']==1): ?>
                                              ...
                                              <?php if($payment_methods['payment_method']=='braintree'): ?>
                                                ...
                                                <div  class="form-check form-check-inline" >
                                                    ...
                                                    <label style="display:none;" class="form-check-label" for="<?php echo e($payment_methods['payment_method']); ?>_label"><img src="<?php echo e(asset('web/images/miscellaneous').'/'.$payment_methods['payment_method'].'.png'); ?>" alt="<?php echo e($payment_methods['name']); ?>"></label>
                                                </div>
                                              <?php else: ?>
                                                  ...
                                                  <div class="form-check form-check-inline" style="margin-bottom:10px;background-color:transparent;">
                                                    ...
                                                    <label class="form-check-label" for="<?php echo e($payment_methods['payment_method']); ?>_label">
                                                      <?php if(file_exists( 'web/miscellaneous/'.$payment_methods['payment_method'].'.png')): ?>
                                                        <img width="70px" height="30px" src="<?php echo e(asset('web/miscellaneous/').'/'.$payment_methods['payment_method'].'.png'); ?>" alt="<?php echo e($payment_methods['name']); ?>">
                                                      <?php else: ?>
                                       ...
                                       <div class="modal fade" id="stripeModel">
                                           <div class="modal-dialog">
                                               ...
                                               <div class="container-lg">
                                                   ...
                                                   <!-- <?php if(file_exists( 'web/miscellaneous/'.$payment_methods['payment_method'].'.png')): ?>
                                                    <div style="width:100%;margin-bottom:10px;"><img width="100px" height="50px" src="<?php echo e(asset('web/miscellaneous/').'/'.'stripe.png'); ?>" alt="stripe"></div>
                                                  <?php endif; ?> -->
                                                       <form>
                                                         <div class="row">
                                                           <div class="field">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/grandisoeemporium_demo/src/resources/views/web/checkout.blade.php ENDPATH**/ ?>