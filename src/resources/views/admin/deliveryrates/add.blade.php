...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> {{ trans('labels.addshippingrate') }} <small>{{ trans('labels.addshippingrate') }}...</small> </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('labels.addshippingrate') }}</li>
        </ol>
    </section>
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">{{ trans('labels.addshippingrate') }}</h3>
                    </div>
                            ...
                            <div class="col-xs-12">
                                <div class="box box-info"><br>
                                    ...
                                    <div class="box-body">
                                        ...
                                        {!! Form::open(array('url' =>'admin/deliveryrates/add', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text('delivery_price', '', array('class'=>'form-control number-validate', 'id'=>'delivery_price'))!!}
